export default {
  ...
  statusFailed: 'Failed',
  instantHint: 'Content already on disk — new link created',
  reusedHint: 'Same image already in your library — original link returned',
  ...
  onboardingCta: 'Open Settings',
  onboardingSkip: 'Dismiss',
}
