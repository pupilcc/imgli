...
const userRow = {
  ...
  is_admin: false, used_storage: 5 * GB, created_at: '2026-07-16T00:00:00Z', image_count: 12,
}
...
it('封禁:InlineConfirm 两击 PATCH status', async () => {
  mockBackend()
  renderPage()
  await screen.findByText('ling')
