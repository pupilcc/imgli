...
```bash
curl -fsSL https://raw.githubusercontent.com/yixian-huang/imgli/main/scripts/install.sh | sh -s -- v0.7.1
...
Pin a release with `ghcr.io/yixian-huang/imgli:v0.7.1` (see
...
./imgli version     # git tag via ldflags, e.g. v0.7.1
